                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <a class="dropdown-item" href="student_info.php">Show all</a>
                            
                            <a class="dropdown-item" href="first_year.php">first year</a>
                            <a class="dropdown-item" href="sec_year.php">Second year</a>
                            <a class="dropdown-item" href="third_year.php">thrid year</a>
                            <a class="dropdown-item" href="fourth_year.php">Fourth year</a>
                            </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM students WHERE gradelevel = 'fourth year college'";
                            $query_run = mysqli_query($con, $query);
                            ...
                            if ($query_run) {
                                ...
                                $query = "SELECT * FROM students WHERE gradelevel = 'fourth year college' LIMIT $offset, $entriesPerPage";
                                $query_run = mysqli_query($con, $query);
                    ...
                    <!-- Pagination -->
                    <div class="clearfix">
                        <div class="hint-text">Showing <b><?= min($totalEntries, $offset + $entriesPerPage); ?></b> out of <b><?= $totalEntries; ?></b> entries</div>
                        <ul class="pagination">
                            <?php
                            for ($i = 1; $i <= $totalPages; $i++) {
                                $activeClass = ($i == $currentPage) ? 'active' : '';
                            ?>
                                <li class="page-item <?= $activeClass; ?>"><a href="?page=<?= $i; ?>" class="page-link"><?= $i; ?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
