                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM students WHERE gradelevel = 'Third year college'";
                            $query_run = mysqli_query($con, $query);
                            ...
                            if ($query_run) {
                                ...
                                $query = "SELECT * FROM students WHERE gradelevel = 'Third year college' LIMIT $offset, $entriesPerPage";
                                $query_run = mysqli_query($con, $query);
